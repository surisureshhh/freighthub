...
var ShipmentUpdate = /** @class */ (function () {
    function ShipmentUpdate(shipmentSearchIndex) {
        this.shipmentSearchIndex = shipmentSearchIndex;
        this.updateQueue = [];
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.shipmentSearchIndex.updateShipment(id, shipmentData)];
                    case 2:
                        processTime = _a.sent();
                        console.log('Shipment Updated \n', __assign(__assign({ id: id }, shipmentData), processTime));
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
                        console.log('Shipment update failed', e_1.stack);
                        return [3 /*break*/, 4];
                    case 4:
                        this.updateQueue = this.updateQueue.filter(function (idx) { return idx !== id; });
